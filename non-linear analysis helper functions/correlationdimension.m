...
if isempty(mmax), mmax=10; end
if isempty(tittxt), tittxt=[]; end
if isempty(fac), fac=4; end
if isempty(logrmin), logrmin=-1000000; end
if isempty(logrmax), logrmax=1000000; end
